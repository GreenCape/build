...
/**
 * Version dependent assertions for Joomla! versions based on platform 11.1 or newer
 *
 ...
 * @since       1.0
 */
class PlatformElevenAssertions extends DefaultAssertions
{
	/**
	...
	public function userCanManage($asset, $message = null)
	{
		...
		if (!\JFactory::getUser()->authorise('core.manage', $asset))
		{
