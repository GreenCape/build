 ...
 * @since    1.0.0
 */
class FromClause extends SqlClause
{
	/**
	 * Constructor
	 *
	 * @param   QueryBuilder|array|string  $data   Initial data
	 * @param   string                     $alias  Optional table alias
	 *
	 * @throws \RuntimeException
	 */
	public function __construct($data, $alias = null)
	{
		...
		$this->data[] = new TableReference($data, $alias);
	}
