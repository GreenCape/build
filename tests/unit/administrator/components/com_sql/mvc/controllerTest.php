...
class SqlControllerUnitTest extends PHPUnit_Framework_TestCase
{
	/** @var SqlController */
	...
	protected function setUp()
	{
		...
		$version->input       = $this->getMock('Input', array('getString', 'getCmd', 'getWord'));
		$this->controller     = new SqlController($version);
	}
	...
	{
		$this->assertInstanceOf('SqlController', $this->controller);
	}
}
