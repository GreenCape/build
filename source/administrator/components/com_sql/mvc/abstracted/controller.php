...
if (!class_exists('AbstractedBaseController'))
{
	if (interface_exists('\\JController'))
	{
		/**
		 * Class AbstractedBaseController
		 *
		 * @package  Celtic\SqlManager
		 * @since    1.0.0
		 */
		abstract class AbstractedBaseController extends \JControllerLegacy
		{
		}
	}
	else
	{
		 ...
		 * @since    1.0.0
		 */
		class AbstractedBaseController extends \JController
		{
		}
	}
}
